...
class TechnicianEquipmentListScreen extends StatefulWidget {
  ...
  State<TechnicianEquipmentListScreen> createState() =>
      _TechnicianEquipmentListScreenState();
}

class _TechnicianEquipmentListScreenState
    extends State<TechnicianEquipmentListScreen> {
  ...
  Future<void> _loadEquipments() async {
    ...
    try {
      ...
      // FILTRO PRINCIPAL: Cargar solo equipos asignados al técnico actual
      equipmentProvider.loadEquipmentsByTechnician(user.uid);
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Error cargando equipos: $e'),
          ...
          Expanded(
            child: Consumer<EquipmentProvider>(
              builder: (context, equipmentProvider, child) {
                ...
                // Usar technicianEquipments en lugar de clientEquipments
                List<Equipment> filteredEquipments = _getFilteredEquipments(
                    equipmentProvider.technicianEquipments);
  ...
  Widget _buildQuickFilters() {
    return Consumer<EquipmentProvider>(
      builder: (context, equipmentProvider, child) {
        List<Equipment> equipments = equipmentProvider.technicianEquipments;
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text(
                    '$totalCount equipo${totalCount != 1 ? 's' : ''} asignado${totalCount != 1 ? 's' : ''}',
                    ...
                    child: OutlinedButton.icon(
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                FaultReportScreen(equipment: equipment),
                          ),
                        );
                      },
                  ...
                  OutlinedButton.icon(
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              QRDisplayScreen(equipment: equipment),
                        ),
                      );
                    },
          ...
          children: [
            ...
            Text(
              hasFilters
                  ...
                  : 'Cuando se te asignen equipos aparecerán aquí',
              style: TextStyle(
                color: Colors.grey[500],
              ),
              textAlign: TextAlign.center,
